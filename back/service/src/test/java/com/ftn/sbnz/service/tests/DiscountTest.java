...
//        SessionPseudoClock clock = ksessionCommonRule.getSessionClock();
        ...
        Contract contract1 = new Contract(0L, LocalDateTime.now().minusMonths(12), LocalDateTime.now().plusMonths(2), true, client, new Packages(0L, null, "aaa", 10.0, PackageType.CABLE, true), 0.0, true);
        Contract contract2 = new Contract(1L, LocalDateTime.now().minusMonths(12), LocalDateTime.now().plusMonths(2), true, client, new Packages(0L, null, "aaa", 10.0, PackageType.CABLE, true), 0.0, true);
        Contract contract3 = new Contract(2L, LocalDateTime.now().minusMonths(12), LocalDateTime.now().plusMonths(2), true, client, new Packages(0L, null, "aaa", 10.0, PackageType.CABLE, true), 0.0, true);
        Contract contract4 = new Contract(3L, LocalDateTime.now().minusMonths(12), LocalDateTime.now().plusMonths(2), true, client, new Packages(0L, null, "aaa", 10.0, PackageType.CABLE, true), 0.0, true);
        Contract contract5 = new Contract(3L, LocalDateTime.now().minusMonths(12), LocalDateTime.now().plusMonths(2), true, client, new Packages(0L, null, "aaa", 10.0, PackageType.CABLE, true), 0.0, true);
        Contract contract6 = new Contract(3L, LocalDateTime.now().minusMonths(12), LocalDateTime.now().plusMonths(2), true, client, new Packages(0L, null, "aaa", 10.0, PackageType.CABLE, true), 0.0, true);
